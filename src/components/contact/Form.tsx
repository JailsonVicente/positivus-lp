    ...
    return (
        <div className={`flex items-center justify-between lg:py-[40px] lg:pl-[40px] lg-h-[773px] lg:bg-Grey lg:rounded-[45px] lg:overflow-hidden`}>
            <div className={`bg-[#F3F3F3] rounded-[45px] px-[30px] py-[40px] lg:w-[556px] lg:mb-[40px] flex flex-col items-center w-full h-auto`}>
                {/* <form onSubmit={validateForm} autoComplete="on" className="w-full flex flex-col gap-[25px] items-center">
                    ...
                    <label className="flex flex-col gap-[10px] w-full">
                        ...
                        <input
                            ...
                            placeholder="Name"
                            autoComplete="name"
                            className="h-[60px] rounded-[14px] py-[18px] px-[20px] border border-black placeholder-opacity-50 placeholder-gray-500"
                        />
                    </label>
                    ...
                    <label className="flex flex-col gap-[10px] w-full">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            inputMode="email"
                            className={`h-[60px] rounded-[14px] py-[18px] px-[20px] border border-black placeholder-opacity-50 placeholder-gray-500 ${errors.email ? 'border-red-500' : ''}`}
                        />
                    ...
                    <label className="flex flex-col gap-[10px] w-full">
                        ...
                        <textarea
                            ...
                            placeholder="Message"
                            autoComplete="off"
                            className={`h-[132px] rounded-[14px] py-[18px] px-[20px] border border-black placeholder-opacity-50 placeholder-gray-500 resize-none ${errors.message ? 'border-red-500' : ''}`}
                        ></textarea>
                        {errors.message && <span className="text-red-500 text-sm">{errors.message}</span>}
                    </label>

                    <button type="submit" className="h-[68px] rounded-[14px] bg-Dark text-white w-full mt-[30px]">
                        Send Message
                    </button>
                ...
                <form onSubmit={validateForm} className="w-full flex flex-col gap-[25px] items-center" autoComplete="off">
                    ...
                    <label className="flex flex-col gap-[10px] w-full">
                        ...
                        <input
                            type="text"
                            name="name" // Name in lowercase for consistency
                            id="name" // Add ID if necessary
                            placeholder="Name"
                            autoComplete="name" // Ensure autocomplete is explicitly set
                            className={`
      ...
      `}
                    ...
                    <label className="flex flex-col gap-[10px] w-full">
                        ...
                        <input
                            type="email"
                            name="email" // Ensure the name is consistent and lowercase
                            id="email" // Add ID if necessary
                            placeholder="Email"
                            autoComplete="email" // Explicitly set autocomplete for email
                            className={`
        h-[60px] rounded-[14px] py-[18px] px-[20px]
        border border-black
        placeholder-opacity-50 placeholder-gray-500
      ...
      `}
                    ...
                    <label className="flex flex-col gap-[10px] w-full">
                        <span className="text-[14px] lg:text-[16px]">Message*</span>
                        <textarea
                            name="message" // Lowercase for consistency
                            id="message" // Add ID if necessary
                            placeholder="Message"
                            autoComplete="off" // Explicitly turn off autocomplete for this field
                            className={`
